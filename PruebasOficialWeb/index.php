...
/*                            transform: translateY(-5px);*/
    ...
    <body>
        ...
        <div class="container" id="content-container">
            <h1 style="margin-top:0px; margin-bottom: 0px; font-size:60px ; text-align: center; font-family: Helvetica Neue; ">Runa Store</h1>
        ...
        <script>
            ...
            sidebar.addEventListener('mouseover', () => {
                ...
                contentContainer.style.width = 'calc(100% - 100px)';
